...
class Order implements \JsonSerializable
{
	...
	private ?int $installmentQty = null;
	public function getInstallmentQty()
	{
		return $this->installmentQty;
	}
	public function setInstallmentQty(int $installmentQty)
	{
	...
	public static function fromJsonDeserializedData($data)
	{
		...
		if (array_key_exists("installmentQty", $realdata)) {
			$returnObject->setInstallmentQty($realdata["installmentQty"]);
		}
